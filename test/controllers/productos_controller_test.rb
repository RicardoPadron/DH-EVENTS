...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { imagen_url: @producto.imagen_url, material: @producto.material, nombre: @producto.nombre, precio: @producto.precio } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { imagen_url: @producto.imagen_url, material: @producto.material, nombre: @producto.nombre, precio: @producto.precio } }
